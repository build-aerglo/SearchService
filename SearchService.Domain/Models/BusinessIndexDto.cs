...
// Elasticsearch index document. Contains all fields needed for search and display.
// Sensitive internal credentials (AccessUsername, AccessNumber) and large binary
// data (QrCodeBase64) are intentionally excluded — they must never be indexed.
